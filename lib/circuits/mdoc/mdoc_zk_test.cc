...
#include "circuits/mdoc/interop_proof.h"
...
TEST_F(MdocZKTest, verifier_interop) {
  StaticString pkx = StaticString(
         "0xdc1c1f55cff4cd5c76cf4169278f7217667f86ee81d8669b63f2e19bc12a0c9f");
  StaticString pky = StaticString(
         "0x12355dd0385fed3bc33bedc9781b9aad47b33e4c24704b8d14288b1b3cb45c28");
  uint8_t transcript[] = {};
  size_t transcript_len = 143;
  const char* now = "2024-10-01T09:00:00Z";
  RequestedAttribute attrs[] = {test::age_over_18};
  MdocVerifierErrorCode ret = run_mdoc_verifier(
    circuit1_, circuit_len1_, pkx.as_pointer, pky.as_pointer, transcript,
    transcript_len, attrs, 1, now, (const uint8_t*)interop_proof_bin,
    (size_t)interop_proof_bin_len, kMDLDocType, &kZkSpecs[0]);
}
